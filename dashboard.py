...
with h3:
    periodo_label = st.selectbox(
        "Periodo", ["Últimos 7 días", "Últimos 14 días", "Últimos 30 días", "Últimos 90 días"],
        index=0, label_visibility="collapsed",
    )
    PERIODO_DIAS = {"Últimos 7 días": 7, "Últimos 14 días": 14, "Últimos 30 días": 30, "Últimos 90 días": 90}
