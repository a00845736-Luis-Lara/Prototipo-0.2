...
with h3:
    periodo_label = st.selectbox(
        "Periodo", ["Últimos 7 días", "Últimos 14 días", "Últimos 30 días"],
        index=0, label_visibility="collapsed",
    )
    PERIODO_DIAS = {"Últimos 7 días": 7, "Últimos 14 días": 14, "Últimos 30 días": 30}
...
with p1:
    render_table_panel("SERVICIO AL CLIENTE", data["servicio"], data["historico"], n=n_dias)
with p2:
    render_table_panel("PRODUCTIVIDAD OPERATIVA", data["productividad"], data["historico"], n=n_dias)
with p3:
    render_table_panel("INVENTARIOS", data["inventarios"], data["historico"], n=n_dias)
with p4:
    render_table_panel("COSTOS", data["costos"], data["historico"], n=n_dias)
